...
async function main() {
    ...
    await prisma.item.createMany({
        data: [
            {
                name: "Bulldozer",
                referalId: "J8NBu7ew".toUpperCase(),
                description:
            ...
            {
                name: "Bulldozer",
                referalId: "cGhcNfG2".toUpperCase(),
                description:
                    "A powerful machine used for moving earth, rocks, and debris. It is equipped with a large blade at the front for pushing material.",
                model: "BDZ1000",
                unit: "UNIT",
            ...
            {
                name: "Excavator",
                referalId: "CtzgucCu".toUpperCase(),
                description:
            ...
            {
                name: "Backhoe",
                referalId: "7jlzimAN".toUpperCase(),
                description:
            ...
            {
                name: "Loader",
                referalId: "xAeTKuK4".toUpperCase(),
                description:
            ...
            {
                name: "Grader",
                referalId: "J4mpUmal".toUpperCase(),
                description:
            ...
            },
            {
                ...
                referalId: "uQoUMlJh".toUpperCase(),
                description:
            ...
            {
                name: "Concrete Mixer",
                referalId: "xvYuSRXF".toUpperCase(),
                description:
            ...
            {
                name: "Concrete Pump",
                referalId: "dRTTrmXg".toUpperCase(),
                description:
            ...
            },
            {
                ...
                referalId: "5PjOEYyS".toUpperCase(),
                description:
